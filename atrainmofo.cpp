...
void firstPage()
{
    cout << "\n_____________________________" << endl;
        cout << "_________WELCOME TO XYZ RAILWAYS___________" << endl
             << endl;
    ...
    case 2:
    {
        ...
        case 1:
        {
            ...
            cout << "___________CREATING NEW ACCOUNT____________" << endl;
            cout << "\nEnter the New ID: ";
            cin >> uid;
            cout << "\nEnter Password: ";
            cin >> upass;
        ...
        {
            cout << "____________________________" << endl;
            cout << "___________LOGING IN______________" << endl;
    ...
    case 3:
    {
        ...
        cout << "______Thanks for using XYZ Railways________" << endl
             << endl;
        exit(0);
    }
    }
...
public:
    ...
    void dispBill()
    {
        ...
        cout << "_XYZ Railways__" << endl;
        cout << "_Tickets___" << endl;
        cout << "_____" << endl
             << endl;
        ;
...
public:
    ...
    void foodOptions()
    {
        ...
        cout << "_______WELCOME TO E-CATERING SERVICE________" << endl
             << endl;
    ...
    void displayMenu()
    {
        fcharges = 0;
        cout << "\n________________________" << endl;
        cout << "_________FOOD MENU____________" << endl
             << endl;
    ...
    void displayFoodReceipt()
    {
        ...
        cout << "_________ORDER RECIEPT____________" << endl
             << endl;
    ...
    void displayFoodDatabase()
    {
        ...
        cout << "\n__________________________" << endl;
        cout << "_________FOOD DATABASE____________" << endl
             << endl;
...
void mainMenu()
{
    ...
    case 2:
    {
        cout << "__Book a ticket in this section_" << endl
             << endl;
        r.trains();
        break;
    }
    ...
    case 3:
    {
        cout << "_Getting your Ticket__" << endl
             << endl;
        t.Bill();
